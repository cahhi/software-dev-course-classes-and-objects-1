...
public class StringUtilities {
    ...
    // characters
    public static boolean shortString(String n) {
        if (n.length() < 5) {
            return true;
        } else {
            return false;
    ...
    public static Character firstLetter(String n) {
        return n.charAt(0);
    }
    ...
    public static String censorAsparagus(String n) {
        return null;
    }
    ...
    public static String bigger(String n) {
        return null;
    }
}
